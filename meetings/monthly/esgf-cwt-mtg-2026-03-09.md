# ESGF Compute Working Team Meeting - 2026-03-09
...
Carsten:
* piddiplatsch ready for use:
    * https://github.com/ESGF/piddiplatsch
    * A Kafka consumer to register ESGF datasets in handle PID service
